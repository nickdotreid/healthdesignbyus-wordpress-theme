...
function roots_scripts() {
  ...
  if($is_IE){
    wp_enqueue_style('roots_main', get_template_directory_uri() . '/assets/css/ie.min.css', false, 'f9ee691d36f8f7affafb373ab263838d');
  }else{
    wp_enqueue_style('roots_main', get_template_directory_uri() . '/assets/css/main.min.css', false, 'f9ee691d36f8f7affafb373ab263838d');    
  }
